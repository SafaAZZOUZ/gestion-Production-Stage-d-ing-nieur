package ma.ocp.gestionP.security.controllers;
...
import lombok.Data;
import ma.ocp.gestionP.security.utilities.JWTUtil;
...
public class AccountRestController {
    ...
    @PostAuthorize("hasAuthority('ADMIN')")
    public AppUser updateUser(@PathVariable Long userId, @RequestBody AppUser updatedUser) {
        return accountService.updateUser(userId, updatedUser);
    }
